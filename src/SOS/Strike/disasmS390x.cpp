...
#undef _TARGET_S390X_
#ifndef _TARGET_S390X_
#define _TARGET_S390X_
#endif
...
void S390XMachine::IsReturnAddress(TADDR retAddr, TADDR* whereCalled) const
{
   /*
    *whereCalled = 0;
...
// @ARMTODO: Figure out how to extract this information under S390X 
BOOL S390XMachine::GetExceptionContext (TADDR stack, TADDR PC, TADDR *cxrAddr, CROSS_PLATFORM_CONTEXT * cxr,
...
///
void S390XMachine::DumpGCInfo(GCInfoToken gcInfoToken, unsigned methodSize, printfFtn gcPrintf, bool encBytes, bool bPrintHeader) const
{
   /*
    if (bPrintHeader)
    {
